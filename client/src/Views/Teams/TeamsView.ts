...
import type { CreateNewTeamPopup } from "./CreateNewTeamPopup";
...
export class TeamsView {
  ...
  async renderTeams() {
            ...
            createElement({
              ...
              children: [
                ...
                createElement({
                  ...
                  text: `${
                    this.allTeamsLeader.length + this.allTeamsParticipant.length
                  } total teams`,
                }),
              ],
            }),
    ...
    this.teamLeaderContainer = teamsSection.children[1].children[0]
      .children[1] as HTMLElement;
    this.teamParticipantContainer = teamsSection.children[1].children[0]
  ...
  //CORE LOGIC-----------------------------------------------------
  handleCreateTeamPopup = async () => {
    const { CreateNewTeamPopup } = await import("./CreateNewTeamPopup");
